...
class TestFlaskApp:
    ...
    def test_create_admin_success(self):
        ...
        response = self.app.post('/api/v1/admins', json={"username": "admin1", "password": "password1"})
    ...
    def test_create_admin_second_success(self):
        # sends HTTP POST request to the application
        # on the specified path with valid data
        response = self.app.post('/api/v1/admins', json={"username": "admin2", "password": "password2"})
    ...
    def test_create_admin_existing_admin(self):
        ...
        response = self.app.post('/api/v1/admins', json={"username": "admin1", "password": "password2"})
    ...
    def test_admin_login_success(self):
        # sends HTTP POST request to the application
        # on the specified path with valid data
        response = self.app.post('/api/v1/admins/login', json={"username": "admin1", "password": "password1"})
    ...
    def test_admin_login_invalid_username(self):
        # sends HTTP POST request to the application
        # on the specified path with invalid data
        response = self.app.post('/api/v1/admins/login', json={"username": "admin3", "password": "password1"})
    ...
    def test_admin_login_invalid_password(self):
        # sends HTTP POST request to the application
        # on the specified path with invalid data
        response = self.app.post('/api/v1/admins/login', json={"username": "admin1", "password": "password2"})
