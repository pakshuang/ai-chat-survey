...
- **Request Body:** JSON format containing username and password.
- **Response:** A message confirming the creation of the admin.
...
- **Request Body:** JSON format containing username and password.
- **Response:** JWT token along with its expiry date.
...
- **Request Body:** JSON format containing survey details.
- **Response:** Survey ID of the created survey.
...
- **Response:** Survey object containing metadata, title, subtitle, questions, and chat context.
...
- **Response:** Response ID of the submitted response.
...
- **Response:** Response object containing metadata and answers.
...
- **Request Body:** JSON format containing the message content.
- **Response:** Chatbot's message content and indication of whether it's the last message.
